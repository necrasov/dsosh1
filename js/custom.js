...
//________Home page main-slider function by = owl.carousel.js________//
...
//________home_team_carousel function by = owl.carousel.js________//	

function home_team_carousel(){
	jQuery('.home-team-carousel').owlCarousel({
		loop:true,
		margin:30,
		autoplay:true,
		lazyLoad:true,
...
---------------------------------------------------------------------------------------------*/
	jQuery(document).ready(function() {
			...
			site_search(),
			contact_slide(),
			//________Bell container Show Hide function by = custom.js ________//
			bell_btn(),
	       //________  Sidebar sticky  when scroll down function by = theia-sticky-sidebar.js ========== //		
			sticky_sidebar(),
			//________ Counter Up  function by = counterup.min.js ========== //		
			...
			//________Home page team Carousel function by = owl.carousel.js________//	
			home_team_carousel(),
			//________ Login Signup Form function by = custom.js ________//		
			Get_in_touch()
